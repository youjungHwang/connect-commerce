...
public class LikesService {
    ...
    @Transactional
    public void addLikesToPost(Long principalId, Long postId){
        if (principalId == null) {
        ...
        Likes likes = Likes.builder()
                ...
                .actionUserId(principalId) // 좋아요를 누른 사용자의 ID
    ...
    @Transactional
    public void addLikesToComment(Long principalId, Long commentId){
        if (principalId == null) {
            throw new RuntimeException("인증된 사용자 정보를 조회할 수 없습니다.");
        }
